...
Version  : 1.4.1
Release  : 79
URL      : https://github.com/testing-cabal/subunit/archive/1.4.1/subunit-1.4.1.tar.gz
Source0  : https://github.com/testing-cabal/subunit/archive/1.4.1/subunit-1.4.1.tar.gz
...
%prep
%setup -q -n subunit-1.4.1
cd %{_builddir}/subunit-1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668021590
